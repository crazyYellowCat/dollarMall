  ...
  <scroll-view class="viewport" scroll-y enable-back-to-top @scrolltolower="onScrolltolower">
    ...
    <view class="profile" :style="{ paddingTop: safeAreaInsets!.top + 'px' }">
      ...
      <view class="overview" v-if="userStore.profile">
        ...
        <view class="meta">
          <view class="nickname"> {{ userStore.profile?.nickname || userStore.profile?.account }} </view>
    ...
    <view class="orders">
      ...
      <view class="section">
        ...
        <navigator v-for="item in orderTypes" :key="item.type" :class="item.icon"
          :url="`/pageOrder/list/list?type=${item.type}`" class="navigator" hover-class="none">
          {{ item.text }}
        </navigator>
        <!-- 客服 -->
        <!-- #ifdef MP-WEIXIN -->
