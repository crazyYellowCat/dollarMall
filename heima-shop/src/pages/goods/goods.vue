...
//ts字面量类型
let popupName = ref<'service' | 'address'>()
//vue3获取组合式API获取popup组件
const popup = ref<{
    open: (type?: UniHelper.UniPopupType) => void,
    close: () => void
}>()
//打开popup 
const openPopup = (name: 'service' | 'address') => {
    ...
    <scroll-view scroll-y class="viewport">
        ...
        <view class="goods">
            ...
            <view class="preview">
                <swiper circular @change="onChange">
                    <swiper-item v-for="(item, index) in goods?.mainPictures" :key="index" @tap="onTapImage(item)">
        ...
        <view class="detail panel">
            ...
            <view class="content">
                ...
                <!-- 图片详情 -->
                <image mode="widthFix" :src="item" v-for="(item, index) in goods?.details.pictures" :key="item">
                </image>
